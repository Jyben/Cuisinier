...
public static class MenuEndpoints
{
        ...
        BackgroundMenuService backgroundMenuService)
    {
        ...
        var menuId = await menuService.StartMenuGenerationAsync(request, userId);
        ...
        backgroundMenuService.StartGenerateMenuInBackground(menuId, request, userId);
        ...
        IMenuService menuService)
    {
        ...
        var menu = await menuService.GetMenuAsync(id, userId);
    ...
    private static async Task<IResult> GetLastParameters(
        ClaimsPrincipal user,
        IMenuService menuService)
    {
        var userId = user.GetUserId();
        ...
        var parameters = await menuService.GetLastParametersAsync(userId);
        ...
        IMenuService menuService)
    {
        ...
        await menuService.SaveParametersAsync(parameters, userId);
        return Results.Ok();
    }

    private static async Task<IResult> GetAllMenus(
        ClaimsPrincipal user,
        IMenuService menuService)
    {
        var userId = user.GetUserId();
        ...
        var menus = await menuService.GetAllMenusAsync(userId);
        ...
        IMenuService menuService)
    {
        ...
        var recipe = await menuService.ReplaceRecipeAsync(menuId, recipeId, request, userId);
        ...
        IMenuService menuService)
    {
        ...
        var recipe = await menuService.ReplaceIngredientAsync(menuId, recipeId, request, userId);
        return Results.Ok(recipe);
    }
        ...
        IMenuService menuService)
    {
        ...
        await menuService.DeleteMenuAsync(menuId, userId);
        return Results.NoContent();
    }
        ...
        IMenuService menuService)
    {
        ...
        var menu = await menuService.ValidateMenuAsync(menuId, request, userId);
        return Results.Ok(menu);
    }
}
